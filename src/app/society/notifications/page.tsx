...
import { Megaphone, Bell, Check, Trash2, MailOpen } from "lucide-react";
...
export default function SocietyNotificationsPage() {
  ...
  const myNotifications = notifications.filter(
    (n) => n.userId === user?.id || n.userId === "all_residents"
  );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Read alerts, transaction updates, and safety broadcasts sent to your flat
          </p>
        </div>
