...
const sections = [
  { title: "Profile Settings", description: "Update your name, room, and contact info", icon: User, color: "from-blue-500 to-cyan-500" },
  { title: "Notifications", description: "Manage alerts for mess, laundry, and events", icon: Bell, color: "from-amber-500 to-orange-500" },
  ...
  { title: "Help & Support", description: "FAQs, contact warden, and hostel rules", icon: HelpCircle, color: "from-teal-500 to-cyan-500" },
];
