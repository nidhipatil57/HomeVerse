...
export const getPrepopulatedComplaints = (): any[] => [
  {
    id: "CMP-001",
...
export const getPrepopulatedLeaveRequests = (): any[] => [
  {
    id: "LEAVE-001",
...
export const getPrepopulatedVisitors = (): any[] => [
  {
    id: "VIS-001",
    name: "Sanjay Mehta",
...
export const getPrepopulatedLaundrySlots = (): any[] => {
  const prepopulatedLaundrySlots: any[] = [];
  const machines = [
...
export const getPrepopulatedParcels = (): any[] => [
  {
    id: "PRC-001",
...
export const getPrepopulatedMarketplaceItems = (): any[] => [
  {
    id: "MKT-001",
...
export const getPrepopulatedMaintenanceBills = (): any[] => [
  {
    id: "BILL-001",
...
export const getPrepopulatedCommunityEvents = (): any[] => [
  {
    id: "EV-001",
...
export const getPrepopulatedNotifications = (): any[] => [
...
export const getPrepopulatedUsers = (): any[] => [
  // --- SECRETARY ---
  {
    id: "user-secretary-1",
    name: "Rahul Verma",
...
export const getPrepopulatedEmergencies = (): any[] => [
  {
    id: "EMG-001",
    residentId: "user-resident-2",
    residentName: "Nidhi Kumar",
...
export const getPrepopulatedGatePasses = (): any[] => [
  {
    id: "PASS-001",
...
export const getPrepopulatedVehicleLogs = (): any[] => [
  {
    id: "VEH-001",
...
export const getPrepopulatedIncidents = (): any[] => [
  {
    id: "INC-001",
...
export const getPrepopulatedAnnouncements = (): any[] => [
  {
    id: "ANN-001",
...
export const getPrepopulatedExpenses = (): any[] => [
  {
    id: "EXP-001",
...
export const getPrepopulatedRentRecords = (): any[] => [
  {
    id: "RNT-001",
    unit: "101",
    building: "B Wing",
